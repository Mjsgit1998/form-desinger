...
import { eltableSchema } from "@/extension/samples/extension-schema";
import EltableWidget from "@/extension/samples/eltable/eltable-widget.vue";
import { eltableTemplateGenerator } from "@/extension/samples/extension-sfc-generator";
...
export const loadExtension = function (app) {
  ...
  addCustomWidgetSchema(eltableSchema);
  app.component(EltableWidget.name, EltableWidget); //注册组件

  PERegister.registerCPEditor(
    app,
    "eltable-description",
    "eltable-description-editor",
    PEFactory.createInputTextEditor(
      "description",
      "extension.setting.description"
    )
